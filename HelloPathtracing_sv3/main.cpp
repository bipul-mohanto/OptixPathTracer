...
// bm: write to file
                ...
                std::ofstream file1("../../HelloPathtracing_sv3/data_save.tsv", std::ios::app);
                if (!file1) {
                ...
                file1.close();
#else
                std::ofstream file2("../../HelloPathtracing_V4/cc.dat", std::ios::app);
...
//--------------------------------------------------------------------
        ...
        //!TODO: saving frame machanism 
        //const std::string fileName = "../../HelloPathtracing_sv3/osc_example2.png";
